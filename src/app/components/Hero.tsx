  ...
  <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
    <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
      <h1 className="title-font sm:text-4xl text-3xl mb-4 font-bold text-gray-900 font-sans bg-purple-100 ">My Name Is Shaista Toseef And I Am 
        <br className="hidden lg:inline-block font-sans" /><Typewriter
  options={{
    strings: ['Program Developer And Student Of G.I.A.I.C', 'Professional Developer In Typescript And Agentic A.I And Machine Learning And Graphic Designer'],
    autoStart: true,
    loop: true,
  }}
/>
